...
import type { Character, CharacterFull, CharactersSearchParams, TenraiPerson, TenraiPersonFull, TenraiResponse, PeopleSearchParams, CharacterAnimeAppearance, CharacterMangaAppearance, CharacterVoiceActorData, PersonAnimeWork, PersonMangaWork, PersonVoiceRole } from './models';
...
export const entityApi = tenraiApi.injectEndpoints({
    endpoints: (builder) => ({
        getTopPeople: builder.query<TenraiResponse<TenraiPerson[]>, { limit?: number; }>({
            query: ({ limit = 15 }) => {
                return {
        ...
        getTopCharacters: builder.query<TenraiResponse<Character[]>, { limit?: number; }>({
            query: ({ limit = 15, }) => {
                return {
        ...
        getCharacterById: builder.query<TenraiResponse<CharacterFull>, { id: number; }>({
            query: ({ id }) => ({
        ...
        getPersonById: builder.query<TenraiResponse<TenraiPersonFull>, { id: number; }>({
            query: ({ id }) => ({
        ...
        getCharacterSearch: builder.query<TenraiResponse<Character[]>, CharactersSearchParams>({
            query: (params) => {
                return {
        ...
        getPeopleSearch: builder.query<TenraiResponse<TenraiPerson[]>, PeopleSearchParams>({
            query: (params) => {
                return {
        ...
        getCharacterAnime: builder.query<TenraiResponse<CharacterAnimeAppearance[]>, { id: number }>({
            query: ({ id }) => ({
        ...
        getCharacterManga: builder.query<TenraiResponse<CharacterMangaAppearance[]>, { id: number }>({
            query: ({ id }) => ({
        ...
        getCharacterVoices: builder.query<TenraiResponse<CharacterVoiceActorData[]>, { id: number }>({
            query: ({ id }) => ({
        ...
        getPersonAnime: builder.query<TenraiResponse<PersonAnimeWork[]>, { id: number }>({
            query: ({ id }) => ({
        ...
        getPersonManga: builder.query<TenraiResponse<PersonMangaWork[]>, { id: number }>({
            query: ({ id }) => ({
        ...
        getPersonVoices: builder.query<TenraiResponse<PersonVoiceRole[]>, { id: number }>({
            query: ({ id }) => ({
