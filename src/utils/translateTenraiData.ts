...
async function translateText(text: string, targetLang: string): Promise<string> {
  ...
  // Jika target language adalah english, return as-is (API Tenrai default English)
  ...
  try {
    ...
    if (process.env.NODE_ENV === 'development') {
      console.error('[TranslateTenraiData] Translation error:', error);
    }
...
export class TenraiTranslator {
  ...
  // Generic translate untuk response API Tenrai
  static async translateTenraiResponse<T>(
    response: T,
    targetLang: 'id' | 'jp' | 'en',
...
export const translateAnime = TenraiTranslator.translateAnime.bind(TenraiTranslator);
export const translateManga = TenraiTranslator.translateManga.bind(TenraiTranslator);
export const translateCharacter = TenraiTranslator.translateCharacter.bind(TenraiTranslator);
export const translateTenraiResponse = TenraiTranslator.translateTenraiResponse.bind(TenraiTranslator);
